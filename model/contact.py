...
class Contact:
    def __init__(self, firstname=None, middlename=None, lastname=None,
                 ...
                 all_phones_form_homepage = None, all_emails_form_homepage = None):
        ...
        self.notes = notes
        self.id = id
        self.all_phones_form_homepage = all_phones_form_homepage
        self.all_emails_form_homepage = all_emails_form_homepage
